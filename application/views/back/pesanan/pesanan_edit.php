    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group"><label>Instansi (*)</label>
                                    <?php echo form_dropdown('', $get_all_combobox_instansi, $data_arsip->instansi_id, $instansi_id) ?>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group"><label>Cabang (*)</label>
                                    <?php echo form_dropdown('', $get_all_combobox_cabang, $data_arsip->cabang_id, $cabang_id) ?>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group"><label>Divisi (*)</label>
                                    <?php echo form_dropdown('', $get_all_combobox_divisi, $data_arsip->divisi_id, $divisi_id) ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group"><label>Nama Arsip (*)</label>
                        <?php echo form_dropdown('', $get_all_combobox_arsip, $pesanan->arsip_id, $arsip_id) ?>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    <?php if (is_grandadmin()) { ?>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group"><label>Instansi (*)</label>
                                    <?php echo form_dropdown('', $get_all_combobox_instansi, $pesanan->instansi_id, $instansi_id_pemesan) ?>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group"><label>Cabang (*)</label>
                                    <?php echo form_dropdown('', $get_all_combobox_pemesan_cabang, $pesanan->cabang_id, $cabang_id_pemesan) ?>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group"><label>Divisi (*)</label>
                                    <?php echo form_dropdown('', $get_all_combobox_pemesan_divisi, $pesanan->divisi_id, $divisi_id_pemesan) ?>
                                </div>
                            </div>
                        </div>
                    <?php } elseif (is_masteradmin() or is_superadmin() or is_admin()) { ?>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3"><label>Bukti Transfer Saat Ini:</label>
                            <?php
                            ...
                            <?php } elseif ($ext_file[1] == "pdf") { ?>
                                <iframe src="<?php echo base_url() ?>admin/pesanan/pdf_frame/<?php echo $pesanan->id_order ?>" width="100%" height="300px"></iframe>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="row">
